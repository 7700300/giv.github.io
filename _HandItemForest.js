...
io_parm[1]="<a href=javascript:void(0); onclick=\"alert('Not&nbsp;Found');R(2);\" title=\"Надеть Топор\"><img border=0 src=http://apeha.ru/img/lic/24s.gif width=16 height=16 style=\"background-color:white;\"></a>";
...
io_parm[1]="<a href=javascript:void(0); onclick=\"frames['handforest'].location.href='bag_type_17.html?actUser-Wear="+io_parm[1]+"';RTitle='Топор лесоруба';R(2);\" title='Надеть Топор"+i+"' id='hif_3'><img border=0 src=\"http://apeha.ru/img/lic/24s.gif\" "
+"onload=\""
...
if(reg.test(breq)) {
io_parm[1]=document.getElementsByTagName("td")[i+2].getElementsByTagName("input")[0].value;
io_parm[1]="<a href=javascript:void(0); onclick=\"frames['handforest'].location.href='bag_type_17.html?actUser-Wear="+io_parm[1]+"';RTitle='Топор лесоруба';R(2);\" title='Надеть Топор1' id='hif_3'><img border=0 src=\"http://apeha.ru/img/lic/24s.gif\" "
+"onload=\""
+"if(RTitle=='Топор лесоруба' && RHandUp==1){"
+"frames['handforest'].location.href='bag_type_17.html?actUser-Wear="+io_parm[1]+"';RTitle='Топор лесоруба';R(2);"
+"}"
