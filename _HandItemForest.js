io_parm=new Array();
io_parm[0]="<a href=javascript:void(0); onclick=\"alert('Not&nbsp;Found');R(2);\" title=\"Надеть Кирку\"><img border=0 src=http://apeha.ru/img/lic/25s.gif width=16 height=16 style=\"background-color:white;\"></a>&nbsp;";
...
io_parm[0]="<a href=javascript:void(0); onclick=\"frames['handforest'].location.href='bag_type_17.html?actUser-Wear="+io_parm[0]+"';RTitle='Кирка рудокопа';R(2);\" title='Надеть Кирку"+i+"' id='hif_2'><img border=0 src=\"http://apeha.ru/img/lic/25s.gif\" "
+"onload=\""
...
if(reg.test(breq)) {
io_parm[0]=document.getElementsByTagName("td")[i+2].getElementsByTagName("input")[0].value;
io_parm[0]="<a href=javascript:void(0); onclick=\"frames['handforest'].location.href='bag_type_17.html?actUser-Wear="+io_parm[0]+"';RTitle='Кирка рудокопа';R(2);\" title='Надеть Кирку1' id='hif_2'><img border=0 src=\"http://apeha.ru/img/lic/25s.gif\" "
+"onload=\""
+"if(RTitle=='Кирка рудокопа' && RHandUp==1){"
+"frames['handforest'].location.href='bag_type_17.html?actUser-Wear="+io_parm[0]+"';RTitle='Кирка рудокопа';R(2);"
+"}"
