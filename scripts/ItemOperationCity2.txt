...
ioLocVar++;
WarningLight(0,"actUser-Unwear="+RegArray[1]); 
} else {
...
+"onclick=\"ioTitle=2;AddJS(1,'scripts/ItemOperationCity2.js');\" "
+"style=margin-left:15%;>[High]</a>"
+"<a href=\"javascript:byid('t').innerHTML=LoadImg;void(0);\" "
+"onclick=\"ioTitle=3;AddJS(1,'scripts/ItemOperationCity2.js');\">[Medium]</a>"
+"<a href=\"javascript:byid('t').innerHTML=LoadImg;void(0);\" "
+"onclick=\"ioTitle=1;AddJS(1,'scripts/ItemOperationCity2.js');\" "
+"oncontextmenu=\"ioTitle=4;AddJS(1,'scripts/ItemOperationCity2.js');"
+"byid('t').innerHTML=LoadImg;return false;\">[Low&#189;]</a>";
return document.location="room.html";
}
top.frames["d_pers"].document.getElementById("t").innerHTML=""
+"<a href=\"javascript:byid('t').innerHTML=LoadImg;void(0);\" "
+"onclick=\"top.frames['d_pers'].ioTitle=0;AddJS(1,'scripts/ItemOperationCity2.js');\" "
+"style=margin-left:70%;>[�����]</a>";
...
top.frames["d_pers"].document.getElementById("t").innerHTML="<a href=\"#\" onclick=\"AddJS(1,'scripts/ItemOperationCity2.js');\" style=margin-left:70%; title="+a+">[�������]</a>";
...
top.frames["d_pers"].document.getElementById("t").innerHTML=""
+"<a href=\"#\" onclick=\"AddJS(1,'scripts/ItemOperationCity2.js');\" style=margin-left:70%; title="+a+">[�������]</a>";
document.location="room_mode_0_type_7.chtml";
}}
}
if(a==3) {
...
if(location.host=="forest.apeha.ru" || !top.frames["d_pers"].LocSite("value","INPUT","�����")) {
top.frames["d_pers"].document.getElementById("t").innerHTML="Error ������ not found.";
} else {
